                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Pago Creador</h3>
                        </div>
                        ...
                        <div class="table-responsive min-vh-100">
                            <table class="table card-table table-vcenter text-nowrap datatable">
                                ...
                                <tbody>
                                @forelse ($pagoCreadors as $pagoCreador)
                                    <tr>
                                        ...
                                        <td>{{ ++$i }}</td>
											...
											<td>{{ $pagoCreador->monto }}</td>
											<td>{{ $pagoCreador->metodo_pago }}</td>
											<td>{{ $pagoCreador->cuenta_bancaria }}</td>
                       ...
                       <div class="card-footer d-flex align-items-center">
                            {!! $pagoCreadors->links('tablar::pagination') !!}
                        </div>
                    </div>
                </div>
            </div>
