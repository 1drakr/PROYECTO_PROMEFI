        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('solicitudproyecto.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Solicitudproyecto</h3>
                        </div>
                        ...
                        <div class="table-responsive min-vh-100">
                            <table class="table card-table table-vcenter text-nowrap datatable">
                                ...
                                <tbody>
                                @forelse ($solicitudproyectos as $solicitudproyecto)
                                    <tr>
                                        <td><input class="form-check-input m-0 align-middle" type="checkbox"
                                                   aria-label="Select solicitudproyecto"></td>
                                        <td>{{ ++$i }}</td>
                                            ...
                                            <td>{{ $solicitudproyecto->proyecto->ubicacion }}</td>
											...
											<td>{{ $solicitudproyecto->fecha_registro }}</td>
											<td>{{ $solicitudproyecto->estado->nombre_estado }}</td>
                                            <td>{{ $solicitudproyecto->proyecto->completado }}</td>
                       ...
                       <div class="card-footer d-flex align-items-center">
                            {!! $solicitudproyectos->links('tablar::pagination') !!}
                        </div>
                    </div>
                </div>
            </div>
